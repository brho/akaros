...
static char*netmulti(struct netif *nif, struct netfile *f, uint8_t *addr, int add);
...
struct walkqid*
netifwalk(struct netif *nif, struct chan *c, struct chan *nc, char **name, int nname, struct errbuf *perrbuf)
{
	return devwalk(c, nc, name, nname, (struct dirtab *)nif, 0, netifgen, perrbuf);
}

struct chan*
netifopen(struct netif *nif, struct chan *c, int omode, struct errbuf *perrbuf)
{
	int id;
	struct netfile *f;
...
long
netifread(struct netif *nif, struct chan *c, void *a, long n, int64_t off, struct errbuf *perrbuf)
{
	int i, j;
	struct netfile *f;
	char *p;
	...
	case Nifstatqid:
		return 0;
	case Nmtuqid:
		snprintf(current->genbuf, sizeof current->genbuf, "%11.ud %11.ud %11.ud\n", nif->minmtu, nif->mtu, nif->maxmtu);
...
struct block*
netifbread(struct netif *nif, struct chan *c, long n, int64_t offset, struct errbuf *perrbuf)
{
 ...
 */
long
netifwrite(struct netif *nif, struct chan *c, void *a, long n, struct errbuf *perrbuf)
{
	ERRSTACK(2);
	struct netfile *f;
	int type, mtu;
...
long
netifwstat(struct netif *nif, struct chan *c, uint8_t *db, long n, struct errbuf *perrbuf)
{
	struct dir *dir;
	struct netfile *f;
	int l;
...
long
netifstat(struct netif *nif, struct chan *c, uint8_t *db, long n, struct errbuf *perrbuf)
{
	return devstat(c, db, n, (struct dirtab *)nif, 0, netifgen, perrbuf);
}

void
netifclose(struct netif *nif, struct chan *c, struct errbuf *perrbuf)
{
	struct netfile *f;
	int t;
	struct netaddr *ap;
 ...
 */
static int
openfile(struct netif *nif, int id, struct errbuf *perrbuf)
{
	ERRSTACK(2);
	struct netfile *f, **fp, **efp;
