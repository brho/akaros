       ...
       uintptr_t sa, long len, int align)
{
	...
	printk("regcpy %#ullx %#ullx %#ulx %#ux\n", da, sa, len, align);
	if((len%align) != 0)
...
loadfacs(uintptr_t pa)
{
	...
	printk("acpi: facs: hwsig: %#ux\n", facs->hwsig);
	printk("acpi: facs: wakingv: %#ux\n", facs->wakingv);
	printk("acpi: facs: flags: %#ux\n", facs->flags);
	printk("acpi: facs: glock: %#ux\n", facs->glock);
	printk("acpi: facs: xwakingv: %#llux\n", facs->xwakingv);
	printk("acpi: facs: vers: %#ux\n", facs->vers);
	printk("acpi: facs: ospmflags: %#ux\n", facs->ospmflags);
	return 0;
}
...
dumpfadt(struct Fadt *fp)
{
	...
	printk("acpi: fadt: facs: %#ux\n", fp->facs);
	printk("acpi: fadt: dsdt: %#ux\n", fp->dsdt);
	printk("acpi: fadt: pmprofile: %#ux\n", fp->pmprofile);
	printk("acpi: fadt: sciint: %#ux\n", fp->sciint);
	printk("acpi: fadt: smicmd: %#ux\n", fp->smicmd);
	printk("acpi: fadt: acpienable: %#ux\n", fp->acpienable);
	printk("acpi: fadt: acpidisable: %#ux\n", fp->acpidisable);
	printk("acpi: fadt: s4biosreq: %#ux\n", fp->s4biosreq);
	printk("acpi: fadt: pstatecnt: %#ux\n", fp->pstatecnt);
	printk("acpi: fadt: pm1aevtblk: %#ux\n", fp->pm1aevtblk);
	printk("acpi: fadt: pm1bevtblk: %#ux\n", fp->pm1bevtblk);
	printk("acpi: fadt: pm1acntblk: %#ux\n", fp->pm1acntblk);
	printk("acpi: fadt: pm1bcntblk: %#ux\n", fp->pm1bcntblk);
	printk("acpi: fadt: pm2cntblk: %#ux\n", fp->pm2cntblk);
	printk("acpi: fadt: pmtmrblk: %#ux\n", fp->pmtmrblk);
	printk("acpi: fadt: gpe0blk: %#ux\n", fp->gpe0blk);
	printk("acpi: fadt: gpe1blk: %#ux\n", fp->gpe1blk);
	printk("acpi: fadt: pm1evtlen: %#ux\n", fp->pm1evtlen);
	printk("acpi: fadt: pm1cntlen: %#ux\n", fp->pm1cntlen);
	printk("acpi: fadt: pm2cntlen: %#ux\n", fp->pm2cntlen);
	printk("acpi: fadt: pmtmrlen: %#ux\n", fp->pmtmrlen);
	printk("acpi: fadt: gpe0blklen: %#ux\n", fp->gpe0blklen);
	printk("acpi: fadt: gpe1blklen: %#ux\n", fp->gpe1blklen);
	printk("acpi: fadt: gp1base: %#ux\n", fp->gp1base);
	printk("acpi: fadt: cstcnt: %#ux\n", fp->cstcnt);
	printk("acpi: fadt: plvl2lat: %#ux\n", fp->plvl2lat);
	printk("acpi: fadt: plvl3lat: %#ux\n", fp->plvl3lat);
	printk("acpi: fadt: flushsz: %#ux\n", fp->flushsz);
	printk("acpi: fadt: flushstride: %#ux\n", fp->flushstride);
	printk("acpi: fadt: dutyoff: %#ux\n", fp->dutyoff);
	printk("acpi: fadt: dutywidth: %#ux\n", fp->dutywidth);
	printk("acpi: fadt: dayalrm: %#ux\n", fp->dayalrm);
	printk("acpi: fadt: monalrm: %#ux\n", fp->monalrm);
	printk("acpi: fadt: century: %#ux\n", fp->century);
	printk("acpi: fadt: iapcbootarch: %#ux\n", fp->iapcbootarch);
	printk("acpi: fadt: flags: %#ux\n", fp->flags);
	printk("acpi: fadt: resetreg: %G\n", &fp->resetreg);
	printk("acpi: fadt: resetval: %#ux\n", fp->resetval);
	printk("acpi: fadt: xfacs: %#llux\n", fp->xfacs);
	printk("acpi: fadt: xdsdt: %#llux\n", fp->xdsdt);
	printk("acpi: fadt: xpm1aevtblk: %G\n", &fp->xpm1aevtblk);
	printk("acpi: fadt: xpm1bevtblk: %G\n", &fp->xpm1bevtblk);
	printk("acpi: fadt: xpm1acntblk: %G\n", &fp->xpm1acntblk);
	printk("acpi: fadt: xpm1bcntblk: %G\n", &fp->xpm1bcntblk);
	printk("acpi: fadt: xpm2cntblk: %G\n", &fp->xpm2cntblk);
	printk("acpi: fadt: xpmtmrblk: %G\n", &fp->xpmtmrblk);
	printk("acpi: fadt: xgpe0blk: %G\n", &fp->xgpe0blk);
	printk("acpi: fadt: xgpe1blk: %G\n", &fp->xgpe1blk);
}
...
dumpmadt(struct Madt *apics)
{
	...
	for(st = apics->st; st != NULL; st = st->next)
		...
		case ASiosapic:
			...
			break;
		case ASintovr:
			printk("\tintovr irq %d intr %d flags %#ux\n",
				st->intovr.irq, st->intovr.intr,st->intovr.flags);
			break;
		case ASnmi:
			printk("\tnmi intr %d flags %#ux\n",
				st->nmi.intr, st->nmi.flags);
			break;
		case ASlnmi:
			printk("\tlnmi pid %d lint %d flags %#ux\n",
		...
		case ASlx2apic:
			...
			break;
		case ASlx2nmi:
			printk("\tlx2nmi puid %d intr %d flags %#ux\n",
...
rsdsearch(char* signature)
{
	...
	if(strncmp(( char *)KADDR(0xFFFD9), "EISA", 4) == 0){
		...
		if((p = (bda[0x0F]<<8)|bda[0x0E])){
			rsd = rsdscan(KADDR(p), 1024, signature);
			if (rsd)
				return rsd;
		}
	}
...
acpirsdptr(void)
{
	...
	printk("acpi: RSD PTR@ %#p, physaddr %#ux length %ud %#llux rev %d\n",
...
Gfmt(void (*putch) (int, void **), void **putdat, struct Gas *g)
{
	...
	case Rpcicfg:
		...
		printfmt(putch, putdat, "dev %#ulx ", (uint32_t)(g->addr >> 32) & 0xFFFF);
		printfmt(putch, putdat, "fn %#ulx ", (uint32_t)(g->addr & 0xFFFF0000) >> 16);
		printfmt(putch, putdat, "adr %#ulx ", (uint32_t)(g->addr &0xFFFF));
		break;
	case Rfixedhw:
		printfmt(putch, putdat, "[hw ");
		break;
	default:
		printfmt(putch, putdat, "[spc=%#ux ", g->spc);
	}
...
acpiintr(Ureg*, void*)
{
	...
	sts = getpm1sts();
	en = getpm1en();
	printd("acpiitr: pm1sts %#ux pm1en %#ux\n", sts, en);
	if(sts&en)
...
#define MKBUS(t,b,d,f)	(((t)<<24)|(((b)&0xFF)<<16)|(((d)&0x1F)<<11)|(((f)&0x07)<<8))
		...
		reg = r;
		printk("region %s %s %llux %llux sz%d",
